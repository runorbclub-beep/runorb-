        ...
        <a-form layout="inline">
          ...
          <a-row :gutter="20">
            <a-col
              ...
              :sm="24"
            >
              <a-form-item label="上午时段">
                <a-range-picker
                  style="width:80%"
                  v-model="queryParam.morning_play_time"
                  @ok="onRangeChange"
                  :show-time="{
            ...
            <a-col
              ...
              :sm="24"
            >
              <a-form-item label="中午时段">
                <a-range-picker
                  style="width:80%"
                  v-model="queryParam.noon_play_time"
                  @ok="onRangeChange"
                  :show-time="{
                    hideDisabledOptions: true,
                    defaultValue: [moment('00:00:00', 'HH:mm:ss'), moment('11:59:59', 'HH:mm:ss')],
            ...
            <a-col
              ...
              :sm="24"
            >
              <a-form-item label="下午时段">
                <a-range-picker
                  style="width:80%"
                  v-model="queryParam.night_play_time "
                  @ok="onRangeChange"
                  :show-time="{
                    hideDisabledOptions: true,
                    defaultValue: [moment('00:00:00', 'HH:mm:ss'), moment('11:59:59', 'HH:mm:ss')],
...
import { getStarList, deleteUserPlay } from '@/api/sport'
  ...
  data() {
    ...
    return {
      ...
      loadData: parameter => {
        ...
        return getStarList(requestParameters).then(res => {
          console.log(res)
  ...
  methods: {
    ...
    resetTable(type) {
      if (type === 1) {
        ...
        this.queryParam.morning_play_time = undefined
      } else if (type === 3) {
        this.queryParam.noon_play_time = undefined
      } else if (type === 4) {
        this.queryParam.night_play_time = undefined
      } else if (type === 5) {
        this.queryParam.is_members = undefined
      } else {
