    ...
    <a-spin :spinning="loading">
      <a-card :bordered="false">
            ...
            <a-row :gutter="48">
              <a-col :md="8" :sm="24">
                <a-form-item label="关键字">
                  <a-input v-model="queryParam.search" placeholder="用户名/团队名" />
                </a-form-item>
              </a-col>
              <a-col :md="(!advanced && 8) || 24" :sm="24">
                ...
                >
                  <a-button type="primary" @click="$refs.teamTable.refresh(true)">查询</a-button>
        ...
        >
          ...
          <span slot="group_property" slot-scope="text">
            {{ text === '1' ? '官方' : '非官方' }}
          </span>
          <span slot="user_img" slot-scope="text, record">
            <img style="width: 50px; heigth: 50px" :src="imgURL + '/' + record.user_img" />
          </span>
          <span slot="group_logo" slot-scope="text, record">
            <img style="width: 50px; heigth: 50px" :src="imgURL + '/' + record.group_logo" />
          </span>
        </s-table>
      </a-card>
    </a-spin>
  ...
  data() {
    ...
    return {
      ...
      loadData: (parameter) => {
        ...
        const requestParameters = Object.assign({ user_id: this.model.user_id }, parameter, this.queryParam)
