...
(function () {
  ...
  const NEWS_DATA = [
    ...
    { id: 2, category: 'announcement', tag: '平台公告', tagClass: 'tag-announcement', icon: 'fa-bullhorn', title: '霸族排行榜全新升级：活力指数正式上线', excerpt: '霸族排行榜（bazu-ranking.cn）完成全面升级，以"活力指数"为核心指标。', date: '2026-04-10',
      content: '<p>霸族排行榜（bazu-ranking.cn）完成全面升级，以<strong>"活力指数"（Energy Index）</strong>为核心指标，涵盖全球6大组别排名。</p><h3>📊 升级内容</h3><ul><li>新增活力指数排名维度</li><li>支持按性别、年龄分组查看</li><li>新增全球/中国/城市三级区域排名</li><li>个人中心新增历史趋势图表</li></ul><p>致力于打造最专业的摇跑运动排名平台，让每一位摇跑爱好者都能找到自己的位置。</p>' },
