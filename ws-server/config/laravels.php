...
return [
    ...
    */
    ...
    'listen_port' => env('LARAVELS_LISTEN_PORT', 5202),
    ...
    */
    ...
    'websocket' => [
        'enable' => true,
         'handler' => \App\Service\WebSocketService::class
    ],
    ...
    */
    ...
    'processes' => [
        ['class' => \App\Processes\RedisPubSubProcess::class, 'enable' => true],
    ],
    ...
    */
    ...
    'timer' => [
        ...
        'jobs'            => [
            ...
            \App\Jobs\Timer\BetweenPkCronJob::class,
            \App\Jobs\Timer\PkResultCronHob::class
        ],
